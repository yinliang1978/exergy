...
model System3pidsummer2t_mass
 ...
 // Exergy.XBuildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
  ...
  Modelica.Blocks.Sources.Constant TRooSetPoi(k=TRooSet)
    ...
    annotation (Placement(transformation(extent={{-130,-128},{-110,
            -108}})));
  ...
  XBuildings.Examples.Tutorial.BaseClasses.myWea myWea
    annotation (Placement(transformation(extent={{-180,36},{-160,56}})));
  ...
  Buildings.Controls.Continuous.LimPID heaCoiCon(
    ...
    yMax=3,
    Ti=100) "Controller for heating coil"
    annotation (Placement(transformation(extent={{-100,-100},{-82,-82}})));
...
equation
  ...
  connect(myWea.weaBus, weaBus) annotation (Line(
      points={{-163.2,45.8},{-130,45.8},{-130,50},{-110,50}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
  ...
  connect(myWea.weaBus, out.weaBus) annotation (Line(
      points={{-163.2,45.8},{-142,45.8},{-142,6},{-142,-21.8},{-140,
          -21.8}},
      color={255,204,51},
      thickness=0.5));
  ...
  connect(cooCoi.viewOutput, viewRoute.viewOutput[4]) annotation (Line(points={{-39.6,
          -35.8},{-39.6,-35.8},{-39.6,-74},{110,-74},{110,80},{101.91,
          80},{101.91,95.405}},
                   color={28,108,200},
      pattern=LinePattern.Dash));
  ...
  connect(souWat.viewOutput, viewRoute.viewOutput[9]) annotation (Line(points={{-20.4,
          -90.2},{101.91,-90.2},{101.91,98.155}},      color={28,108,
          200},
      pattern=LinePattern.Dash));
  connect(theCon.viewOutput, viewRoute.viewOutput[10]) annotation (Line(points={{39.6,
          59.8},{60,59.8},{60,68},{58,68},{58,98.705},{101.91,98.705}},
        color={28,108,200},
      pattern=LinePattern.Dash));
  connect(heaCoiCon.y, souWat.m_flow_in) annotation (Line(points={{-81.1,
          -91},{-62,-91},{-62,-92},{-40,-92}},
                                      color={0,0,127},
      pattern=LinePattern.Dot));
  connect(senTemRoo.T, heaCoiCon.u_s) annotation (Line(points={{90,80},
          {90,-142},{-140,-142},{-140,-91},{-101.8,-91}},               color={0,0,127},
      pattern=LinePattern.Dot));
  ...
  connect(powerSourceForMovers.viewPort, viewRoute.viewOutput[11]) annotation (
      Line(points={{45.72,5.52},{96,5.52},{96,88},{96,99.255},{101.91,
          99.255}},
        color={28,108,200},
      pattern=LinePattern.Dash));
  connect(TRooSetPoi.y, heaCoiCon.u_m) annotation (Line(
      points={{-109,-118},{-91,-118},{-91,-101.8}},
      color={0,0,127},
      pattern=LinePattern.Dot));
