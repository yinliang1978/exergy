...
model case1_summer
 ...
 // Exergy.XBuildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
  ...
  Modelica.Blocks.Sources.Constant TRooSetPoi(k=TRooSet)
    ...
    annotation (Placement(transformation(extent={{-126,-132},{-110,
            -116}})));
...
equation
  ...
  connect(theCon.viewOutput, viewRoute.viewOutput[10]) annotation (Line(points={{39.6,
        ...
        color={28,108,200}));
  connect(heaCoiCon.y, souWat.m_flow_in) annotation (Line(points={{-85,-92},
          {-62,-92},{-40,-92}},       color={0,0,127}));
  connect(senTemRoo.T, heaCoiCon.u_s) annotation (Line(points={{90,80},
          {90,-142},{-132,-142},{-132,-140},{-132,-92},{-108,-92}},     color={0,
          0,127}));
  ...
  connect(TRooSetPoi.y, heaCoiCon.u_m) annotation (Line(points={{
          -109.2,-124},{-96,-124},{-96,-104}}, color={0,0,127}));
