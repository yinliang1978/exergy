...
model case1_varAirFlow
 ...
 // replaceable package MediumW = Buildings.Media.Water "Medium for water";
  ...
  parameter Modelica.SIunits.MassFlowRate mW_flow_nominal=
    -3*QCoiC_flow_nominal/(TWRet_nominal-TWSup_nominal)/4200
 ...
 // Exergy.XBuildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
  ...
  Modelica.Blocks.Sources.Constant TRooSetPoi(k=5) "Room temperature set point"
    annotation (Placement(transformation(extent={{-142,-134},{-126,
            -118}})));
  ...
  Buildings.Controls.Continuous.LimPID heaCoiCon(
    ...
    Td=Td,
    yMin=0.1) "Controller for heating coil"
...
//  parameter Modelica.SIunits.Temperature      roomSetT=273.15+22;
 ...
 Real objectFuctionValue;
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem(redeclare package Medium =
               MediumW, m_flow_nominal=mW_flow_nominal) annotation (
      Placement(transformation(extent={{-66,-50},{-50,-70}})));
  Modelica.Blocks.Math.Feedback feedback annotation (Placement(
        transformation(extent={{-152,-106},{-132,-86}})));
  ...
  Buildings.Controls.Continuous.LimPID heaCoiCon1(
    ...
    controllerType=Modelica.Blocks.Types.SimpleController.PID,
    Td=Td,
    yMax=2*mA_flow_nominal) "Controller for heating coil"
...
equation
  ...
  connect(theCon.viewOutput, viewRoute.viewOutput[10]) annotation (Line(points={{39.6,
        ...
        color={28,108,200},
      pattern=LinePattern.Dash));
  connect(heaCoiCon.y, souWat.m_flow_in) annotation (Line(points={{-83,-96},
          {-83,-92},{-40,-92}},       color={0,0,127},
      pattern=LinePattern.Dot));
  ...
  connect(powerSourceForMovers.viewPort, viewRoute.viewOutput[11]) annotation (
      Line(points={{45.72,5.52},{96,5.52},{96,88},{96,99.78},{101.91,99.78}},
        color={28,108,200},
      pattern=LinePattern.Dash));
  connect(senTem.port_a, sinWat.ports[1]) annotation (Line(points={{
          -66,-60},{-76,-60},{-76,-66}}, color={0,127,255}));
  connect(senTem.port_b, cooCoi.port_b1) annotation (Line(points={{
          -50,-60},{-48,-60},{-48,-58},{-48,-32},{-40,-32}}, color={0,
          127,255}));
  connect(souWat.ports[1], senTem1.port_b) annotation (Line(points={{
          -20,-100},{-4,-100},{-4,-74}}, color={0,127,255}));
  connect(senTem1.port_a, cooCoi.port_a1) annotation (Line(points={{
          -4,-58},{-4,-32},{-20,-32}}, color={0,127,255}));
  ...
  connect(TRooSetPoi1.y, heaCoiCon1.u_m) annotation (Line(points={{
          -35.3,-5},{-24,-5},{-20,-5},{-20,0.4}}, color={0,0,127}));
  connect(senTemRoo.T, heaCoiCon1.u_s) annotation (Line(
      points={{90,80},{90,80},{90,40},{90,80},{-29.6,80},{-29.6,10}},
      color={0,0,127},
      pattern=LinePattern.Dot));

  connect(feedback.y, heaCoiCon.u_s) annotation (Line(points={{-133,
          -96},{-106,-96},{-106,-96}}, color={0,0,127}));
  connect(TRooSetPoi.y, heaCoiCon.u_m) annotation (Line(points={{
          -125.2,-126},{-114,-126},{-114,-128},{-94,-128},{-94,-108}},
        color={0,0,127}));
