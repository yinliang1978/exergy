 ...
 // Exergy.XBuildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
  ...
  Exergy.XBuildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(
   ...
   // energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyStateInitial)
    ...
    Exergy.XBuildings.Fluid.Sources.FixedBoundary sinWat(nPorts=2, redeclare
      package Medium =
  ...
  Modelica.Blocks.Sources.Constant TRooSetPoi(k=TRooSet)
    ...
    annotation (Placement(transformation(extent={{-126,-132},{-110,-116}})));
  ...
  Utilities.ViewRoute viewRoute(nSubSystem=12)
  ...
  Buildings.Controls.Continuous.LimPID heaCoiCon(
    ...
    Td=Td) "Controller for heating coil"
    annotation (Placement(transformation(extent={{-104,-102},{-84,-82}})));
   // k=2,
   // Ti=100,
...
//  parameter Modelica.SIunits.Temperature      roomSetT=273.15+22;
 ...
 //  Buildings.Fluid.Sensors.RelativeTemperature senRelTem(redeclare package
  //    Medium =  MediumW)
...
equation
  ...
  connect(out.viewOutput, viewRoute.viewOutput[1]) annotation (Line(points={{-120.4,
          -12.2},{-120.4,60},{-120.4,93.755},{101.91,93.755}},
                                                         color={28,108,200},
  ...
  connect(hex.viewOutput, viewRoute.viewOutput[2]) annotation (Line(points={{-88.4,
          -16.2},{-96,-16.2},{-96,94.305},{101.91,94.305}},
                                                          color={28,108,200},
      pattern=LinePattern.Dash));
  connect(sinWat.viewOutput, viewRoute.viewOutput[3]) annotation (Line(points={{-60.4,
          -56.2},{-60.4,24},{-60.4,102},{101.91,102},{101.91,94.855}},
        color={28,108,200},
      pattern=LinePattern.Dash));
  ...
  connect(powerSourceForMovers.viewPort, viewRoute.viewOutput[11]) annotation (
      Line(points={{45.72,5.52},{96,5.52},{96,88},{96,99.255},{101.91,99.255}},
        color={28,108,200},
      pattern=LinePattern.Dash));
  connect(TRooSetPoi.y, heaCoiCon.u_m) annotation (Line(
      points={{-109.2,-124},{-94,-124},{-94,-104}},
      color={0,0,127},
      pattern=LinePattern.Dot));
      /*
  connect(senRelTem.port_b, cooCoi.port_a1) annotation (Line(points={{-124,-62},
          {-20,-62},{-20,-32}}, color={0,127,255}));
  connect(senRelTem.port_a, cooCoi.port_b1) annotation (Line(points={{-144,-62},
  {-144,-54},{-40,-54},{-40,-32}}, color={0,127,255}));
  */
