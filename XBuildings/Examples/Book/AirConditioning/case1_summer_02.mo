...
equation
  ...
  connect(theCon.viewOutput, viewRoute.viewOutput[10]) annotation (Line(points={{39.6,
        ...
        color={28,108,200},
      pattern=LinePattern.Dash));
  connect(heaCoiCon.y, souWat.m_flow_in) annotation (Line(points={{-85,-92},{-62,
          -92},{-40,-92}},            color={0,0,127},
      pattern=LinePattern.Dot));
  connect(senTemRoo.T, heaCoiCon.u_s) annotation (Line(points={{90,80},{90,-142},
          {-132,-142},{-132,-140},{-132,-92},{-108,-92}},               color={0,0,127},
      pattern=LinePattern.Dot));
  ...
  connect(TRooSetPoi.y, heaCoiCon.u_m) annotation (Line(
      points={{-109.2,-124},{-96,-124},{-96,-104}},
      color={0,0,127},
      pattern=LinePattern.Dot));
