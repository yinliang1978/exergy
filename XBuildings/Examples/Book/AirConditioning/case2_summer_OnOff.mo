...
model case2_summer_OnOff
 ...
 // replaceable package MediumW = Buildings.Media.Water "Medium for water";
  ...
  parameter Modelica.SIunits.MassFlowRate mW_flow_nominal=
    -2*QCoiC_flow_nominal/(TWRet_nominal-TWSup_nominal)/4200
 ...
 // Exergy.XBuildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
  ...
  Modelica.Blocks.Sources.Constant TRooSetPoi(k=TRooSet)
    ...
    annotation (Placement(transformation(extent={{-162,-112},{-146,-96}})));
  ...
  Modelica.Blocks.Math.BooleanToReal mWat_flow(realTrue=0, realFalse=
    ...
    annotation (Placement(transformation(extent={{-72,-110},{-52,-90}})));
equation
  ...
  connect(TRooSetPoi.y,con. reference) annotation (Line(
      points={{-145.2,-104},{-112,-104}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(senTemRoo.T,con. u) annotation (Line(
      points={{90,80},{116,80},{116,-140},{-124,-140},{-124,-116},{-112,-116}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(con.y,mWat_flow. u) annotation (Line(
      points={{-89,-110},{-76,-110},{-76,-100},{-74,-100}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(mWat_flow.y, souWat.m_flow_in) annotation (Line(
      points={{-51,-100},{-44,-100},{-44,-92},{-40,-92}},
      color={0,0,127},
      smooth=Smooth.None));
