...
model System3p
 ...
 Exergy.XBuildings.Fluid.MixingVolumes.MixingVolume vol(
    ...
    mSenFac=1) annotation (Placement(transformation(extent={{60,20},{80,40}})));
 ...
 // inner Utilities.RefEnv refEnv(T=out.medium.state.T,p=out.medium.state.p,vaporFra=out.medium.state.X[1])
  ...
  Utilities.ViewRoute viewRoute(nSubSystem=8)
...
equation
  ...
  connect(theCon.viewOutput, viewRoute.viewOutput[1]) annotation (Line(points={{39.6,
          59.8},{39.6,70},{-30,70},{-30,89.175},{-18.1,89.175}},  color={28,108,
          200}));
  connect(vol.viewOutput, viewRoute.viewOutput[2]) annotation (Line(points={{79.6,
          39.8},{79.6,62},{-22,62},{-22,89.925},{-18.1,89.925}},
                                                             color={28,108,200}));
  ...
  connect(TOut.viewOutput, viewRoute.viewOutput[3]) annotation (Line(points={{-0.4,
          59.8},{8,59.8},{8,80},{-18.1,80},{-18.1,90.675}},
                                                          color={28,108,200}));
  connect(preHea.viewOutput, viewRoute.viewOutput[4]) annotation (Line(points={{39.6,
          89.8},{39.6,104},{-18.1,104},{-18.1,91.425}},     color={28,108,200}));
  connect(souWat.viewOutput, viewRoute.viewOutput[5]) annotation (
      Line(points={{-20.4,-90.2},{-16,-90.2},{-16,20},{-56,20},{-56,92.175},{-18.1,
          92.175}},            color={28,108,200}));
  connect(sinWat.viewOutput, viewRoute.viewOutput[6]) annotation (Line(points={{-60.4,
          -56.2},{-46,-56.2},{-46,92.925},{-18.1,92.925}},   color={28,108,200}));
  connect(cooCoi.viewOutput, viewRoute.viewOutput[7]) annotation (
      Line(points={{-39.6,-35.8},{-60,-35.8},{-60,86},{-18.1,86},{-18.1,93.675}},
                        color={28,108,200}));
  connect(fan.viewOutput, viewRoute.viewOutput[8])  annotation (Line(
        points={{59.6,-10.2},{-36,-10.2},{-36,90},{-18.1,90},{-18.1,94.425}},
                  color={28,108,200}));
