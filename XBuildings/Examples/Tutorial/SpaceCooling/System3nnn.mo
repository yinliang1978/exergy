...
model System3nnn
 ...
 // Buildings.Fluid.Movers.FlowControlled_m_flow fan(
  ...
  Utilities.ViewRoute viewRoute(nSubSystem=4)
...
equation
  ...
  connect(theCon.viewOutput, viewRoute.viewOutput[1]) annotation (Line(points={{39.6,
          59.8},{39.6,70},{-30,70},{-30,89.55},{-18.1,89.55}},    color={28,108,
          200}));
  connect(vol.viewOutput, viewRoute.viewOutput[2]) annotation (Line(points={{79.6,
          39.8},{79.6,62},{-22,62},{-22,91.05},{-18.1,91.05}},
                                                             color={28,108,200}));
  ...
  connect(TOut.viewOutput, viewRoute.viewOutput[3]) annotation (Line(points={{-0.4,
          59.8},{8,59.8},{8,80},{-18.1,80},{-18.1,92.55}},color={28,108,200}));
  connect(preHea.viewOutput, viewRoute.viewOutput[4]) annotation (Line(points={{
          39.6,89.8},{39.6,104},{-18.1,104},{-18.1,94.05}}, color={28,108,200}));
