within Exergy.XBuildings.Fluid.Interfaces;
model FourPortHeatMassExchanger_X
 ...
 replaceable Buildings.Fluid.MixingVolumes.MixingVolume vol1(
...
First implementation.
    ...
    Icon(coordinateSystem(
        ...
        Rectangle(
          ...
          fillColor={0,0,0},
          fillPattern=FillPattern.Solid)}));
end FourPortHeatMassExchanger_X;
