within Exergy.XBuildings.Fluid.MassExchangers.Examples;
model Humidifier_u "Model that demonstrates the ideal humidifier model"
  ...
  Exergy.XBuildings.Fluid.MassExchangers.Humidifier_u humSte(
    redeclare package Medium = Medium,
  ...
  Exergy.XBuildings.Fluid.MassExchangers.Humidifier_u humDyn(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=6000,
    mWat_flow_nominal=m_flow_nominal*0.005,
