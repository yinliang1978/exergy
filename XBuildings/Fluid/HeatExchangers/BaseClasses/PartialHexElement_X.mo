...
model PartialHexElement_X "Element of a heat exchanger 2"
 // extends Buildings.Fluid.Interfaces.FourPortHeatMassExchanger(
 extends Exergy.XBuildings.Fluid.Interfaces.FourPortHeatMassExchanger_X(
  ...
  Modelica.Blocks.Interfaces.RealInput Gc_2
    ...
    annotation (Placement(transformation(
        ...
        rotation=90)));
/*
    Exergy.XModelica.Thermal.HeatTransfer.Components.HeatCapacitor_Di     mas(
    C=C,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90)));
        */
   //   Exergy.XModelica.Thermal.HeatTransfer.Components.HeatCapacitor mas(C=C,    T(stateSelect=StateSelect.always,
     // fixed=(energyDynamics == Modelica.Fluid.Types.Dynamics.FixedInitial)));
 // Modelica.Thermal.HeatTransfer.Components.HeatCapacitor mas(
//Exergy.XModelica.Thermal.HeatTransfer.Components.HeatCapacitor mas(
  ...
  XModelica.Thermal.HeatTransfer.Components.HeatCapacitor mas( C=C,    T(stateSelect=StateSelect.always,
      fixed=(energyDynamics == Modelica.Fluid.Types.Dynamics.FixedInitial)))
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
...
equation
  ...
  connect(con1.solid,mas.port) annotation (Line(points={{-60,20},{-66,
          20},{-66,0},{-70,0},{-78,0},{-78,-6.12323e-016}},
                           color={191,0,0}));
