...
model System3ss
  ...
  Buildings.Fluid.HeatExchangers.ConstantEffectiveness hex(
    ...
    dp1_nominal=200,
    dp2_nominal=200,
    eps=eps) "Heat recovery" annotation (Placement(transformation(
          extent={{-110,-36},{-90,-16}})));
  ...
  XBuildings.Examples.Tutorial.BaseClasses.myWea myWea annotation (
