...
model TurbineGas_L1_stageStacked
...
public
  ...
  Modelica.Blocks.Interfaces.RealInput Delta_alpha_input(value=Delta_alpha) if useExternalVIGVangle
    "VIGV angle input" annotation (Placement(transformation(extent={{-90,60},{-50,
  ...
  parameter Real eta_isen_stage_nom = 0.9
    "|Nominal Values|Nominal isentropic stage efficiency (axial: ca. 0.9, radial: ca. 0.82)";                                       //Axial compressor: ca. 0.9, Radial compressor: 0.82
