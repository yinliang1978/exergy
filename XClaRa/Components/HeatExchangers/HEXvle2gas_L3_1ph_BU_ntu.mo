...
model HEXvle2gas_L3_1ph_BU_ntu
  "VLE 2 gas | L3 | 1 phase on each side | Block shape | U-type | NTU ansatz"
...
equation
  ...
  connect(shell.inlet, In1) annotation (Line(
      ...
      color={118,106,98},
      thickness=0.5));
  connect(eye_int, eye) annotation (Line(points={{72,80},{90,80},{90,80},{100,80}}, color={190,190,190}));
