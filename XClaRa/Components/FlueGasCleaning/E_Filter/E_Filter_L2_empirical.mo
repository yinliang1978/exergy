...
model E_Filter_L2_empirical
  "Model for an electrical dust filter based on the Deutsch-Equation for the separation rate with empirical numbers for the partical migration speed"
...
//_____________defintion of medium used in cell__________________________________________________________
  ...
  parameter Modelica.SIunits.Velocity w_m= 0.15
    "Migration speed of dust particles in the E-field"                                             annotation(Dialog(group="Fundamental Definitions"));
...
<p><b>Model description: </b>An empirical E-filter model</p>
<p><b>Contact: </b>Andre Th&uuml;ring, Lasse Nielsen, TLK-Thermo GmbH</p>
<p><b>FEATURES</b> </p>
<p><ul>
<li>This model uses TILMedia</li>
<li>Calculates the separation rate according to an empirical equation </li>
