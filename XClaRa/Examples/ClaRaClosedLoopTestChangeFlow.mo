...
model ClaRaClosedLoopTestChangeFlow
...
model Regression
  ...
  XClaRa.Components.TurboMachines.Turbines.SteamTurbineVLE_L1 turbine_HP1(
  ...
  XClaRa.SubSystems.Boiler.SteamGenerator_L3 steamGenerator_1_XRG(
  ...
  XClaRa.Components.TurboMachines.Turbines.SteamTurbineVLE_L1 Turbine_IP(
  ...
  XClaRa.Components.TurboMachines.Turbines.SteamTurbineVLE_L1 Turbine_LP2(
  ...
  XClaRa.Components.TurboMachines.Pumps.PumpVLE_L1_simple Pump_FW(eta_mech=0.8) annotation (Placement(transformation(extent={{-56,-128},{-76,-148}})));
  ...
  XClaRa.Components.HeatExchangers.HEXvle_L3_2ph_BU condenser(
    height=5,
    width=5,
    length=10,
  ...
  XClaRa.Components.MechanicalSeparation.FeedWaterTank_L3_advanced feedWaterTank(
    level_rel_start=0.5,
    diameter=5,
  ...
  XClaRa.Components.TurboMachines.Pumps.PumpVLE_L1_simple Pump_cond(eta_mech=1, showExpertSummary=true) annotation (Placement(transformation(extent={{212,-112},{192,-132}})));
  ...
  XClaRa.Components.VolumesValvesFittings.Fittings.Split_L2_Y join_IP(
  ...
  XClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_IP(redeclare
      model PressureLoss =
    ...
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={34,-42})));
  XClaRa.Components.TurboMachines.Turbines.SteamTurbineVLE_L1 Turbine_LP1(
  ...
  ClaRa.Visualisation.Quadruple quadruple7
    annotation (Placement(transformation(extent={{-30,-10},{30,10}},
        rotation=0,
        origin={142,58})));
  XClaRa.Components.VolumesValvesFittings.Fittings.Split_L2_Y join_LP1(
  ...
  XClaRa.Components.TurboMachines.Pumps.PumpVLE_L1_simple Pump_preheater_LP1(eta_mech=1) annotation (Placement(transformation(extent={{102,-158},{82,-178}})));
  XClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_LP1(redeclare
      model PressureLoss =
  ...
  XClaRa.Components.VolumesValvesFittings.Fittings.Split_L2_Y join_HP(
    volume=0.1,
  ...
  XClaRa.Components.HeatExchangers.HEXvle2vle_L3_2ph_CH_simple preheater_HP(
    ...
    redeclare model PressureLossTubes =
        ...
        rotation=90,
        origin={-140,-40})));
  XClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve1_HP(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-88,-12})));
  XClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve2_HP(
  ...
  XClaRa.Components.HeatExchangers.HEXvle2vle_L3_2ph_CH_simple preheater_LP1(
    redeclare replaceable model WallMaterial =
        TILMedia.SolidTypes.TILMedia_Steel,
  ...
  XClaRa.Components.VolumesValvesFittings.Valves.ValveVLE_L1 valve_LP2(
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={102,-122})));
  XClaRa.Components.VolumesValvesFittings.Fittings.Join_L2_Y join_LP_main(
    initType=ClaRa.Basics.Choices.Init.noInit,
    useHomotopy=false,
    volume=0.2,
  ...
  inner ClaRa.SimCenter simCenter(contributeToCycleSummary=true, redeclare
    ...
    showExpertSummary=true)
    annotation (Placement(transformation(extent={{-278,-220},{-238,-200}})));
 ...
 //inner Utilities.RefEnv refEnv(T=273.15-10)
 inner Utilities.RefEnv refEnv(T=273.15 + 25)
    annotation (Placement(transformation(extent={{284,78},{304,98}})));

    Real totalExergyLoss;
    Real PowerOut= abs(turbine_HP1.P_t + Turbine_IP.P_t + Turbine_LP1.P_t + Turbine_LP2.P_t);
    Real PumpPowerIn = abs(Pump_preheater_LP1.P_drive + Pump_cond.P_drive + Pump_FW.P_drive);
    Real Q_flowIn= abs(steamGenerator_1_XRG.Q_flow_HP + steamGenerator_1_XRG.Q_flow_IP);

    Real ExergyRatio=(PowerOut-PumpPowerIn)/Q_flowIn;
  Modelica.Blocks.Math.Product product annotation (Placement(
        transformation(extent={{-196,-172},{-176,-152}})));
  Modelica.Blocks.Sources.RealExpression realExpression(y=0.5)
    annotation (Placement(transformation(extent={{-238,-190},{-218,-170}})));
equation
       totalExergyLoss= steamGenerator_1_XRG.viewObject.Ex_flow_loss+
                         turbine_HP1.viewObject.Ex_flow_loss+
                         Turbine_IP.viewObject.Ex_flow_loss+
                         Turbine_LP1.viewObject.Ex_flow_loss+
                         Turbine_LP2.viewObject.Ex_flow_loss+
                         join_IP.viewObject.Ex_flow_loss+
                         join_LP1.viewObject.Ex_flow_loss+
                         condenser.viewObject.Ex_flow_loss+
                         Pump_cond.viewObject.Ex_flow_loss+
                         preheater_LP1.viewObject.Ex_flow_loss+
                         valve_LP2.viewObject.Ex_flow_loss+
                         Pump_preheater_LP1.viewObject.Ex_flow_loss+
                         join_LP_main.viewObject.Ex_flow_loss+
                         feedWaterTank.viewObject.Ex_flow_loss+
                         Pump_FW.viewObject.Ex_flow_loss+
                         valve2_HP.viewObject.Ex_flow_loss+
                         preheater_HP.viewObject.Ex_flow_loss+
                         valve1_HP.viewObject.Ex_flow_loss+
                         join_HP.viewObject.Ex_flow_loss+
                         valve_IP.viewObject.Ex_flow_loss+
                         valve_LP1.viewObject.Ex_flow_loss;
  ...
  connect(preheater_HP_relLevel2.y, PI_Pump_preheater2.u_s) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(PTarget.y, product.u1) annotation (Line(points={{-257,58},{-258,
          58},{-258,-156},{-198,-156}}, color={0,0,127}));
  connect(realExpression.y, product.u2) annotation (Line(points={{-217,
          -180},{-204,-180},{-204,-168},{-198,-168}}, color={0,0,127}));
  connect(product.y, Nominal_PowerFeedwaterPump1.u) annotation (Line(
        points={{-175,-162},{-120,-162},{-120,-162}}, color={0,0,127}));
...
end ClaRaClosedLoopTestChangeFlow;
