...
<p><big> This package contains model for thermal storage in solid material,
 heat transfer correlation model, temperature sensors model and temperature sources model
  to impose boundary conditions in a simulation.
