within Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.BaseClasses;
partial model PartialHeatTransfer
  ...
  ThermoCycle.Interfaces.HeatTransfer.ThermalPortL[n] thermalPortL
    annotation (Placement(transformation(extent={{-24,56},{20,76}}),
        iconTransformation(extent={{-24,56},{20,76}})));
