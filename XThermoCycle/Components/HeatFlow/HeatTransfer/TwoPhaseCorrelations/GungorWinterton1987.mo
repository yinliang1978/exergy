within Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.TwoPhaseCorrelations;
model GungorWinterton1987
  "The simplified Gungor-Winterton correlation for turbulent two phase flow"
  extends
    Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.BaseClasses.PartialTwoPhaseCorrelation;
  extends
    Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.BaseClasses.PartialPipeCorrelation;

  replaceable model LiquidCorrelation =
    Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.SinglePhaseCorrelations.DittusBoelter1930
    constrainedby
    Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.BaseClasses.PartialSinglePhaseCorrelation
