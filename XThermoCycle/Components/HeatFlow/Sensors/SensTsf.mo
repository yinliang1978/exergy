within Exergy.XThermoCycle.Components.HeatFlow.Sensors;
model SensTsf "Temperature sensor for  constant heat capacity fluid"
  ...
  ThermoCycle.Interfaces.Fluid.Flange_Cdot inlet annotation (
      Placement(transformation(extent={{-80,-60},{-40,-20}})));
  ThermoCycle.Interfaces.Fluid.Flange_ex_Cdot outlet annotation (
