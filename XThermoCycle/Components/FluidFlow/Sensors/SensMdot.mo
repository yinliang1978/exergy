within Exergy.XThermoCycle.Components.FluidFlow.Sensors;
model SensMdot "Mass Flowrate sensor for working fluid"
  ...
  ThermoCycle.Interfaces.Fluid.FlangeA InFlow(m_flow(min=0),
      redeclare package Medium = Medium) annotation (Placement(
        transformation(extent={{-50,-50},{-30,-30}}),
        iconTransformation(extent={{-50,-50},{-30,-30}})));
  ThermoCycle.Interfaces.Fluid.FlangeB OutFlow(m_flow(min=0),
      redeclare package Medium = Medium) annotation (Placement(
        transformation(extent={{30,-50},{50,-30}}),
