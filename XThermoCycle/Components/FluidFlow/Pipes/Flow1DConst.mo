within Exergy.XThermoCycle.Components.FluidFlow.Pipes;
model Flow1DConst
...
/************ Thermal and fluid ports ***********/
  ThermoCycle.Interfaces.Fluid.Flange_Cdot flange_Cdot annotation (
      Placement(transformation(extent={{-100,-10},{-80,10}}),
        iconTransformation(extent={{-120,-20},{-80,20}})));
  ThermoCycle.Interfaces.Fluid.Flange_ex_Cdot flange_ex_Cdot
...
/******************************** CELLS **************************/
  Exergy.XThermoCycle.Components.FluidFlow.Pipes.CellConst Cells[N](
    redeclare each final model HeatTransfer =
    ...
    Tstart=Tstart,
    each steadystate=steadystate) annotation (Placement(
        transformation(extent={{-30,-66},{24,-22}})));
