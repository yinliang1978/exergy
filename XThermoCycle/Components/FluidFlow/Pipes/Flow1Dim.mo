...
/***************  VARIABLES ******************/
 ...
 replaceable Exergy.XThermoCycle.Components.FluidFlow.Pipes.Cell1Dim Cells[N](
    ...
    hstart=hstart,
    each sat_in={sat.ddldp,sat.ddvdp,sat.dhldp,sat.dhvdp,sat.dTp,sat.hl,
        sat.hv,sat.sigma,sat.sl,sat.sv,sat.dl,sat.dv,sat.psat,sat.Tsat},
    each ComputeSat=false) annotation (Placement(transformation(
          extent={{-28,-48},{26,-4}})));
