...
/************ Thermal and fluid ports ***********/
  ...
  ThermoCycle.Interfaces.Fluid.PortConverter_limit portConverter_in(
      redeclare package Medium = Medium) annotation (Placement(
        transformation(extent={{-62,-30},{-42,-10}})));
  ThermoCycle.Interfaces.Fluid.PortConverter_limit portConverter_out(
      redeclare package Medium = Medium) annotation (Placement(
        transformation(extent={{66,-34},{46,-14}})));
...
/***************  VARIABLES ******************/
 ...
 replaceable Exergy.XThermoCycle.Components.FluidFlow.Pipes.Cell1Dim_limit
                                                                  Cells[N](
    redeclare package Medium = Medium,
    redeclare each final model HeatTransfer =
        Flow1Dim_limitHeatTransferModel,
    each Vi=V/N,
    each Ai=A/N,
    each Nt=Nt,
    ...
    hstart=hstart) annotation (Placement(transformation(extent={{-26,
            -62},{28,-18}})));
