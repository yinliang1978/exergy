...
replaceable model MultiFlow1DimHeatTransferModel =
   ...
   /****************************  CELLS ***************************************/
 Exergy.XThermoCycle.Components.FluidFlow.Pipes.AirCell[N] simpleAirCell(
    ...
    each Unom=Unom,
    each Vi=V_f/N,
    each Ai=A_f/N) annotation (Placement(transformation(extent={{-30,
            -10},{-10,10}})));
Exergy.XThermoCycle.Components.Units.PdropAndValves.DP[N] dP(
