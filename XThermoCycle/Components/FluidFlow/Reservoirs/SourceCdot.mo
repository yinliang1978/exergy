within Exergy.XThermoCycle.Components.FluidFlow.Reservoirs;
model SourceCdot "Flowrate source for Cdot-type heat source"
  ...
  Modelica.Blocks.Interfaces.RealInput T_source
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-73,-21})));
  ThermoCycle.Interfaces.Fluid.Flange_ex_Cdot flange annotation (
      Placement(transformation(extent={{82,-2},{102,18}}),
        iconTransformation(extent={{62,-20},{102,18}})));
