within Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.TestCases;
model ValveTimerTester

  Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.ValveTimer
    valveTimer annotation (Placement(transformation(extent={{0,-40},
            {20,-20}})));
