within Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating;
model RecipMachine_PV
  "Model of single cylinder with pressure and volume connectors"
  extends
    Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.BaseClasses.PartialRecipMachine;
  Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.BaseClasses.VolumeForces
