...
model RecipMachine
  ...
  RecipMachine_Flange recipFlange(redeclare StrokeBoreGeometry
      geometry)
...
Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.HeatTransfer.ConstantHeatTransfer
