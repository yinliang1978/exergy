within Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.BaseClasses;
partial model PartialRecipMachine
  ...
  replaceable parameter
    Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.BaseClasses.BaseGeometry
    geometry constrainedby
    Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.BaseClasses.BaseGeometry
    "Define geometry here or replace with appropriate record."
    annotation (choicesAllMatching=true, Placement(transformation(
          extent={{58,-123},{103,-78}})));
