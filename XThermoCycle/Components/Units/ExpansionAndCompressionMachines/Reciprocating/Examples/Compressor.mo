within Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Reciprocating.Examples;
model Compressor
  "A combination of Cylinder model, a reciprocating machine and check valves"
  replaceable package WorkingFluid =
      ExternalMedia.Media.CoolPropMedium (                              substanceNames={"R134a|calc_transport=1"},mediumName="R134a",ThermoStates = Modelica.Media.Interfaces.Choices.IndependentVariables.ph) constrainedby
