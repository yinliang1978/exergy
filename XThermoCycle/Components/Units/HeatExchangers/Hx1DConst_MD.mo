...
replaceable package Medium1 = ThermoCycle.Media.DummyFluid
  ...
  ThermoCycle.Interfaces.Fluid.Flange_Cdot inletSf annotation (
      Placement(transformation(extent={{88,40},{108,60}}),
        iconTransformation(extent={{90,40},{110,60}})));
  ThermoCycle.Interfaces.Fluid.Flange_ex_Cdot outletSf annotation (
      Placement(transformation(extent={{-106,40},{-86,60}}),
        iconTransformation(extent={{-110,40},{-90,60}})));
  ThermoCycle.Interfaces.Fluid.FlangeA inletWf(redeclare package Medium =
               Medium1) annotation (Placement(transformation(extent={
            {-100,-60},{-80,-40}}), iconTransformation(extent={{-110,
            -60},{-90,-40}})));
  ThermoCycle.Interfaces.Fluid.FlangeB outletWf(redeclare package Medium =
               Medium1) annotation (Placement(transformation(extent={
...
/******************************* COMPONENTS ***********************************/
  ...
  Exergy.XThermoCycle.Components.FluidFlow.Pipes.Flow1Dim_MD WorkingFluid(
    ...
    Tstart_outlet=Tstart_outlet_wf) annotation (Placement(
        transformation(extent={{-44,-124},{50,-36}})));
  HeatFlow.Walls.MetalWall metalWall(
    ...
    steadystate_T_wall=steadystate_T_wall) annotation (Placement(
        transformation(extent={{-40,-50},{46,14}})));
  HeatFlow.Walls.CountCurr countCurr(N=N, counterCurrent=
        counterCurrent)
    annotation (Placement(transformation(extent={{-42,3},{40,48}})));
 Exergy.XThermoCycle.Components.FluidFlow.Pipes.Flow1DConst SecondaryFluid(
    ...
    Discretization=Discretization) annotation (Placement(
        transformation(extent={{44,126},{-44,32}})));
...
replaceable model Medium2HeatTransferModel =
  Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.MassFlowDependence_IdealFluid
    constrainedby
    Exergy.XThermoCycle.Components.HeatFlow.HeatTransfer.BaseClasses.PartialHeatTransferZones_IdealFluid
