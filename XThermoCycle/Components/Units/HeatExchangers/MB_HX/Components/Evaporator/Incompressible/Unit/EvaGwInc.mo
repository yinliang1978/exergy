within Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Evaporator.Incompressible.Unit;
model EvaGwInc
...
Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Wall.wall
    ...
    L_total=Ltotal,
    M_w=Mw,
    TstartWall=TstartWall) annotation (Placement(
        transformation(extent={{-20,-18},{20,18}})));
