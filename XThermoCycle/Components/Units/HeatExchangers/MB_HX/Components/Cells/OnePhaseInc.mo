within Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Cells;
model OnePhaseInc
...
import
    Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Records;
import
    Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Constants;
...
public
  Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Interfaces.MbOut
    mbOut annotation (Placement(transformation(extent={{-10,80},
            {10,100}})));
...
parameter Boolean subcooled = true "Set to true if cell is subcooled" annotation (Dialog(group = "CV"));
 ...
 Modelica.SIunits.Length[3] length "Length vector for summaryClass";
  /* Geometry */
  Modelica.SIunits.Length ll(start=lstart,min = 1) "Lenght of this segment";
  ...
  /* Balance variables */
  Modelica.SIunits.MassFlowRate M_dot(start=Mdotnom) "Mass flow at inlet";
