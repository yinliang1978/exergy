...
annotation (choicesAllMatching = true);
  /* Components */
Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Condenser.CondGeneral
    CondGeneral(
  ...
  Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Wall.wall
    ...
    n=3) annotation (Placement(transformation(extent={{-20,-18},
            {20,18}})));
...
equation
  ...
  connect(Wall.QmbIn, CondGeneral.mbOut)
    annotation (Line(
      points={{-1.6,-16.2},{-1.6,-32},{2,-32},{2,-52}},
      color={0,0,0},
      smooth=Smooth.None));
...
public
  ...
  SummaryClass Summary(T_profile(Twf = CondGeneral.Summary.T_profile.T_cell[:],Twall= Wall.Summary.T_profile.T_cell[:], Tsf = secondaryFluid.Summary.T_profile.T_cell[end:-1:1]),l_cell = CondGeneral.Summary.l_cell[:],Qwf = CondGeneral.Summary.Qtot,Qsf = secondaryFluid.Summary.Qtot);

equation
  connect(InFlowPF, CondGeneral.InFlow) annotation (Line(
      points={{-98,-36},{-70,-36},{-70,-69.6},{-38.8,-69.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(CondGeneral.OutFlow, OutFlowPF) annotation (Line(
      points={{41.2,-69.6},{56,-69.6},{56,-40},{82,-40}},
      color={0,0,255},
      smooth=Smooth.None));
          ...
          preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
            ...
            -60},{80,80}},
                   preserveAspectRatio=false),
                                     graphics={
                               Bitmap(extent={{-100,110},{82,-92}}, fileName="modelica://ThermoCycle/Resources/Images/MB/Cond_G.png")}));
end CondGw;
