within Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Wall;
...
public
  Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Interfaces.MbIn
    QmbIn[n] annotation (Placement(transformation(extent={{-20,
            -32},{20,-12}})));

  Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Interfaces.MbOut
    QmbOut[n] annotation (Placement(transformation(extent={{-20,
            16},{20,34}})));
equation
