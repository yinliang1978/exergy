within Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Tests.TestEvaporator.TestIncompressible;
...
Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Evaporator.EvaGeneral
    evaGeneral(
    ...
    pstart=6000000) annotation (Placement(transformation(
          extent={{-10,-62},{10,-42}})));
Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.SecondaryFluid.SecondaryFluid
    secondaryFluid(
    n=n,
    Usf=1000,
    AA=0.0019,
    YY=1.57,
    L_total=500) annotation (Placement(transformation(extent=
            {{-10,48},{10,68}})));
  Exergy.XThermoCycle.Components.FluidFlow.Reservoirs.SourceMdot
    sourceMdot(
    redeclare package Medium = Medium,
    Mdot_0=0.5,
    T_0=349.15) annotation (Placement(transformation(extent={
            {-72,-60},{-52,-40}})));
  Exergy.XThermoCycle.Components.FluidFlow.Reservoirs.SinkP sinkP(
      redeclare package Medium = Medium, p0=6000000)
    annotation (Placement(transformation(extent={{80,-60},{
            100,-40}})));
  Exergy.XThermoCycle.Components.FluidFlow.Reservoirs.SourceCdot
    sourceCdot(Mdot_0=5, T_0=1273.15) annotation (Placement(
...
Exergy.XThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Wall.wall
    ...
    M_w=80,
    n=3,
    TstartWall={513.15,513.15,673.15}) annotation (Placement(
        transformation(extent={{-10,-6},{10,14}})));
initial equation
