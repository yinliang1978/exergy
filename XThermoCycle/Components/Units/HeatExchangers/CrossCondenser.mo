...
ThermoCycle.Interfaces.Fluid.FlangeB OutFlow_fl2(redeclare package Medium=Medium2)
  ...
  Exergy.XThermoCycle.Components.FluidFlow.Pipes.Flow1DimInc SecondaryFluid(
    ...
    Unom=Unom_sf,
    pstart=100000) annotation (Placement(transformation(extent={{-30,
            -72},{30,-12}})));
  Exergy.XThermoCycle.Components.HeatFlow.Sources.Source_T source_T(N=N)
  ...
  Exergy.XThermoCycle.Components.HeatFlow.Walls.MetalWall metalWall(
    ...
    N=N)
    annotation (Placement(transformation(extent={{2,22},{66,-22}})));
 Exergy.XThermoCycle.Components.HeatFlow.Walls.ThermalResistance ports1(
    N=N,
    A=A_wf,
    U=U_wf)
    annotation (Placement(transformation(extent={{32,18},{92,58}})));
