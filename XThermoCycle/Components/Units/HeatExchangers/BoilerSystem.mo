...
Exergy.XThermoCycle.Components.Units.HeatExchangers.HX_twophase_pT EVA(
    redeclare package Medium_iso = Medium_wf,
    redeclare package Medium_sf = Medium_sf,
    steadystate_T_wall=false,
    M_wall=500,
    T_sf_su_start=T_sf_su_start - (T_sf_su_start - (
        Medium_wf.saturationTemperature(p_start + DELTAp_eva_nom) +
        pinch_start))*1/3,
    T_sf_ex_start=Medium_wf.saturationTemperature(p_start +
        DELTAp_eva_nom) + pinch_start,
    T_iso_start=Medium_wf.saturationTemperature(p_start +
        DELTAp_eva_nom),
    T_w_start=Medium_wf.saturationTemperature(p_start +
        DELTAp_eva_nom) + pinch_start/2,
    A_iso=150,
    A_sf=150,
    U_sf=700,
    U_iso=2000,
    T_wall_fixed=true) annotation (Placement(transformation(extent={{
            -44,-26},{-64,-6}})));
Exergy.XThermoCycle.Components.Units.HeatExchangers.HX_singlephase_pT
    SH1(
    ...
    T_hf_su_start=T_sf_su_start - (T_sf_su_start - (
        Medium_wf.saturationTemperature(p_start) + pinch_start))*1/5,
    T_cf_ex_start=T_w_su_SH2_start,
    T_hf_ex_start=T_sf_su_start - (T_sf_su_start - (
        Medium_wf.saturationTemperature(p_start) + pinch_start))*1/3,
    T_wall_fixed=true,
    A_cf=15,
    A_hf=15) annotation (Placement(transformation(extent={{-66,24},{-46,
            44}})));
...
Exergy.XThermoCycle.Components.Units.HeatExchangers.HX_singlephase_pT
    ...
    T_wall_fixed=true,
    A_cf=15,
    A_hf=15) annotation (Placement(transformation(extent={{-46,48},{-66,
            68}})));
...
Exergy.XThermoCycle.Components.Units.HeatExchangers.HX_singlephase_pT
    ...
    T_hf_ex_start=T_sf_su_start - (T_sf_su_start - (
        Medium_wf.saturationTemperature(p_start) + pinch_start))*6/5,
    T_hf_su_start=Medium_wf.saturationTemperature(p_start) +
        pinch_start,
    T_wall_fixed=true) annotation (Placement(transformation(extent={{
            -68,-58},{-48,-38}})));

Exergy.XThermoCycle.Components.Units.Tanks.Boiler_drum drum(
    redeclare package Medium = Medium_wf,
    p_ng=0,
    Vtot=4,
    pstart=p_start)
    annotation (Placement(transformation(extent={{38,-18},{78,22}})));
  Exergy.XThermoCycle.Components.Units.ExpansionAndCompressionMachines.Pump
    pump(
...
ThermoCycle.Interfaces.Fluid.FlangeB_pT
  ...
  Exergy.XThermoCycle.Components.Units.PdropAndValves.DP DP_eva(
    redeclare package Medium = Medium_wf,
    UseNom=true,
    use_rho_nom=true,
  ...
  Exergy.XThermoCycle.Components.Units.PdropAndValves.DP DP_eco(
    redeclare package Medium = Medium_wf,
    UseNom=true,
    use_rho_nom=true,
    Mdot_nom=3.28,
    ...
    p_nom=4200000,
    T_nom=353.15) annotation (Placement(transformation(extent={{-24,-56},
            {-10,-42}})));
