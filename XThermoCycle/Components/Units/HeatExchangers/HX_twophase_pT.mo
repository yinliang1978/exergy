...
/******************************* COMPONENTS *****************************/
 ...
 Exergy.XThermoCycle.Components.Units.HeatExchangers.Semi_isothermal_HeatExchanger_pT
    semi_isothermal_HeatExchanger(redeclare package Medium =
        Medium_sf, AU=A_sf*U_sf)
  ...
  ThermoCycle.Interfaces.HeatTransfer.HeatPortConverter heatPortConverter(N=1, A=
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={23,47})));
  Exergy.XThermoCycle.Components.HeatFlow.Walls.MetalWallL metalWallL(
    Aext=A_sf,
    Aint=A_iso,
    M_wall=M_wall,
    c_wall=c_wall,
  ...
  Exergy.XThermoCycle.Components.HeatFlow.Sources.Source_T_cell source_T_cell
    annotation (Placement(transformation(extent={{-26,-34},{24,-74}})));
  Exergy.XThermoCycle.Components.HeatFlow.Walls.ThermalResistanceL thermalResistanceL(
    U=U_iso,
    A=A_iso,
    Qdot(start=(T_w_start - T_iso_start)*A_iso*U_iso)) annotation (
      Placement(transformation(extent={{-14,10},{32,-28}})));
equation
