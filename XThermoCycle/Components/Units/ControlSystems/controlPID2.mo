within Exergy.XThermoCycle.Components.Units.ControlSystems;
model controlPID2
 ...
 Exergy.XThermoCycle.Components.Units.ControlSystems.Blocks.DELTAT dELTAT
    annotation (Placement(transformation(extent={{-60,-34},{-40,-14}})));
  Exergy.XThermoCycle.Components.Units.ControlSystems.Blocks.Tev_SPOptim
    tev_SP annotation (Placement(transformation(extent={{-60,54},{-40,
            74}})));
...
equation
  connect(DELTAT_SP.y, PID_pump.SP) annotation (Line(
      points={{-49.4,10},{4.3,10},{4.3,15.4},{20,15.4}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(DELTAT_SP.y, init.u1) annotation (Line(
      points={{-49.4,10},{-36,10},{-36,-1.8},{-22,-1.8}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(const_pump.y, init2.u1) annotation (Line(
      points={{46.6,-24},{46.6,-2},{64.6,-2},{64.6,8.34}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PID_pump.CS, init2.u2) annotation (Line(
      points={{46.78,11},{55.39,11},{55.39,13.8},{64.6,13.8}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(init2.y, CS_Xpp) annotation (Line(
      points={{80.56,11.14},{89.28,11.14},{89.28,9},{111,9}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(p_cd, tev_SP.p_cd) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(Mdot, firstOrder.u) annotation (Line(
      points={{-86,26},{-86,33},{-70.8,33},{-70.8,34}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(firstOrder.y, tev_SP.Mdot) annotation (Line(
      points={{-61.6,34},{-56,34},{-56,59.8},{-60,59.8}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(PID_expander.CS, init3.u2) annotation (Line(
      points={{46.78,72},{57.69,72},{57.69,71.8},{68.6,71.8}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(init3.y, CS_freq) annotation (Line(
      points={{84.56,69.14},{90.28,69.14},{90.28,73},{111,73}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const_exp.y, init3.u1) annotation (Line(
      points={{46.6,36},{60,36},{60,66.34},{68.6,66.34}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (
