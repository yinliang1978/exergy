within Exergy.XThermoCycle.Components.Units.Solar;
...
inner replaceable parameter
    Exergy.XThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.Geometry.Schott_SopoNova.BaseGeometry
    CollectorGeometry constrainedby
    Exergy.XThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.Geometry.Schott_SopoNova.BaseGeometry
...
/******************************************  COMPONENTS *********************************************************/
  ...
  Exergy.XThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.AbsSchottSopo[
    Ns] absorberSchott(each N=N, each geometry=CollectorGeometry)
  ...
  ThermoCycle.Interfaces.Fluid.FlangeA InFlow(redeclare package Medium =
            ...
            {-10,-100},{10,-80}}), iconTransformation(extent={{28,-112},
            {48,-92}})));
  ThermoCycle.Interfaces.Fluid.FlangeB OutFlow(redeclare package Medium =
               Medium1) annotation (Placement(transformation(extent={
            {-10,80},{10,100}}), iconTransformation(extent={{28,110},
            {48,130}})));
  FluidFlow.Pipes.Flow1DimInc[Ns] flow1DimInc(
    ...
    each Discretization=Discretization) annotation (Placement(
        transformation(
