...
replaceable model FluidHeatTransferModel =
 ...
 /******************************* COMPONENTS ***********************************/
    HeatFlow.Walls.SolarAbsorber.SolAbsForristal[Ns] solAbs(
    each eps1=eps1,
    each eps2=eps2,
    each eps3=eps3,
    each rho_cl=rho_cl,
    ...
    each th_g=th_g,
    each Dext_t=Dext_t,
    each th_t=th_t) annotation (Placement(transformation(extent={{-30,
            -16},{14,34}})));
  ...
  ThermoCycle.Interfaces.Fluid.FlangeA InFlow(redeclare package Medium =
            ...
            {28,-110},{48,-90}}), iconTransformation(extent={{28,-110},
            {48,-90}})));
  ThermoCycle.Interfaces.Fluid.FlangeB OutFlow(redeclare package Medium =
               Medium1) annotation (Placement(transformation(extent={
            {30,106},{50,126}}), iconTransformation(extent={{30,106},
            {50,126}})));
