...
inner replaceable parameter
    Exergy.XThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.Geometry.Soltigua.BaseGeometry
...
/******************************************  COMPONENTS *********************************************************/
 ...
 Exergy.XThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.AbsSoltigua[
    Ns] SolarAbsorber(
    each N=N,
    each geometry=CollectorGeometry,
    each Defocusing=Def)
  ...
  ThermoCycle.Interfaces.Fluid.FlangeA InFlow(redeclare package Medium =
            ...
            {-10,-100},{10,-80}}), iconTransformation(extent={{18,-112},
            {38,-92}})));
